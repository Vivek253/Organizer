...
public class sub6 extends AppCompatActivity {
    ...
    public boolean check(String a, String b,String c,String d,String e,String f){//RETURN 1 if SAFE

        if((a.equals(f))||(a.equals(b))||(a.equals(c))||(a.equals(d))||(a.equals(e)))
            return false;
        if((b.equals(c))||(b.equals(d))||(b.equals(e))||(b.equals(f)))
            return false;
    ...
    public void createsubs(View view){
        ...
        EditText s6 = (EditText) findViewById(R.id.sub6);
        ...
        EditText a6 = (EditText) findViewById(R.id.abb6);

        String is1,is2,is3,is4,is5,is6,ia1,ia2,ia3,ia4,ia5,ia6;
        ...
        ia6 = a6.getText().toString();
        l = min(3,ia6.length());
        ia6 = ia6.substring(0,l);
        ia6=fixout(ia6);
        //NEW

        if(!((is1.equals(""))||(is2.equals(""))||(is3.equals(""))||(is4.equals(""))||(is5.equals(""))||(is6.equals(""))||(ia1.equals(""))||(ia2.equals(""))||(ia3.equals(""))||(ia4.equals(""))||(ia5.equals(""))||(ia6.equals(""))))
        {
            if((check(is1,is2,is3,is4,is5,is6))&&(check(ia1,ia2,ia3,ia4,ia5,ia6))) {
                SQLiteDatabase db = openOrCreateDatabase("myData", MODE_PRIVATE, null);
                String sqlst = "insert into sub values('" + user + "','" + is1 + "','" + is2 + "','" + is3 + "','" + is4 + "','" + is5 + "','" + is6 + "','" + ia1 + "','" + ia2 + "','" + ia3 + "','" + ia4 + "','" + ia5 + "','" + ia6 + "')";
                ...
                db.execSQL("insert into att values('" + user + "','" + is6 + "',0,0)");
                db.execSQL(sqlst);
                db.execSQL(exec);
