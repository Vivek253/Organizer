...
public class sub4 extends AppCompatActivity {
    ...
    public boolean check(String a, String b,String c,String d){//RETURN 1 if SAFE
    ...
    public void createsubs(View view){
        ...
        String is1,is2,is3,is4,ia1,ia2,ia3,ia4;
        ...
        if(!((is1.equals(""))||(is2.equals(""))||(is3.equals(""))||(is4.equals(""))||(ia1.equals(""))||(ia2.equals(""))||(ia3.equals(""))||(ia4.equals(""))))
        {
            if((check(is1,is2,is3,is4))&&(check(ia1,ia2,ia3,ia4))) {
                String sqlst = "insert into sub values('" + user + "','" + is1 + "','" + is2 + "','" + is3 + "','" + is4 + "','" + "" + "','" + "" + "','" + ia1 + "','" + ia2 + "','" + ia3 + "','" + ia4 + "','" + "" + "','" + "" + "')";
                db.execSQL(sqlst);
